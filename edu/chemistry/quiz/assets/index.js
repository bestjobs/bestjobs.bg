const quizData = [
    ...
    {
      question: "2. Броят на подслоевете на даден слой с равен на:<br> HELP: help: "Електронният слой K, който съдържа само подслой s, може да има най-много 2 електрона; L слоят, който има s и p подслой, може да има 2+6=8 електрона и т.н. Общата формула е, че n-ият слой може да съдържа до 2n2 електрона.",
