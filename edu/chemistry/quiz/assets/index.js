const quizData = [
    {
      ...
      question: "HELP: Химичните свойства на атома зависят практически само от строежа на електронната обвивка, която от своя страна се определя от заряда на ядрото Z (броя на протоните) и почти не зависи от неговото масово число A (сумата на протоните Z и неутроните N). Всички изотопи на един и същ елемент имат еднакъв заряд на ядрото и се отличават само по броя на неутроните, следователно имат еднакви химични свойства."
    },
    {
